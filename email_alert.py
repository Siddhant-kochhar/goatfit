#!/usr/bin/env python3
"""
HadesFit Emergency Email Alert Service - Gmail SMTP
...
SENDER_NAME = "HadesFit Emergency Alert"
...
This alert was automatically generated by HadesFit Health Monitoring System.
...
📱 Dashboard: http://localhost:8000/vitals
            ...
            <div style="max-width: 600px; margin: 0 auto; background: #000;">
                ...
                <div style="text-align: center; padding: 30px 20px; border-top: 1px solid #333; margin: 20px;">
                    <div style="color: #888; font-size: 14px;">
                        <p style="margin: 5px 0;"><strong style="color: #fff;">HadesFit Health Monitoring System</strong></p>
    ...
    def test_email_service(self, test_email: str) -> bool:
        ...
        subject = "🧪 HadesFit Emergency Alert System Test"
        text_body = f"""
🧪 HadesFit Emergency Alert System Test

This is a test message from HadesFit Emergency Alert System.
...
This test was sent from HadesFit Health Monitoring Dashboard.

---
HadesFit - Your Health Guardian 🏥💚
        """
        ...
        <head>
            <meta charset="UTF-8">
            <title>HadesFit System Test</title>
        </head>
...
if __name__ == "__main__":
    ...
    print("🏥 HadesFit Emergency Alert System - Gmail SMTP Version")
    print("=" * 60)
